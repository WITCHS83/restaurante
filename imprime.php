...
<table width="100%">
	...
	<?php	
	$carrinho2 = mysqli_query("SELECT * FROM tbl_carrinho WHERE comanda = '$numero'") or die(mysqli_error());
	$contar2 = mysqli_num_rows($carrinho2);
	
	if($contar2 == 0){
		echo "Adicione itens";
	}else{		
		while($res2 = mysqli_fetch_array($carrinho2)){		
