...
$idMESA = $_GET['id_mesa'];
$id_garcon = $mostra['idGarcon'];
$altera = mysqli_query("UPDATE mesa SET idGarcon = '$id_garcon', situacao = '1' WHERE id_mesa = '$idMESA' ") or die(mysqli_error());
...
<a href="javascript:confirmar('?abre=abrir&id_mesa=<?php echo $idmesa ?>&idGarcon=<?php echo $mostra['idGarcon']; ?>')"><div id="abreMesa">ABRIR MESA</div></a>	
      ...
      <div data-role="content">
            ...
            <ul data-role="listview" data-inset="true">
	<?php 
        $sql = mysqli_query("SELECT * FROM categoria ORDER BY nome ASC") or die(mysqli_error);
