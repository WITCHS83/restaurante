...
if(isset($_POST['alterar'])){
	...
	$conf = mysqli_query("SELECT * FROM garcon WHERE login ='$login'");
	$conta = mysqli_num_rows($conf);
	...
	$sql = mysqli_query("UPDATE garcon SET nomeGarcon='$nome', login = '$login', senha='$senha', nv='$nv' WHERE idGarcon='$cods'")or die(mysqli_error());
...
<div id="boxcadProdutos">
	...
	$cod = $_GET['cod'];
	$sql_select = mysqli_query("SELECT * FROM garcon WHERE idGarcon='$cod'");
