...
date_default_timezone_set('America/Sao_Paulo'); 
  $sql1 = mysqli_query("SELECT * FROM tbl_carrinho ORDER BY comanda DESC") or die(mysqli_error());
  ...
  $proxima1 = $numero1 + 1;
	...
	if($proxima1 >= 1000){
		...
		$muda = mysqli_query("UPDATE tbl_carrinho SET comanda ='0'") or die(mysqli_error());
	}
...
<div id="boxprodutos">
	...
	$seleciona = mysqli_query("SELECT * FROM tbl_produtos WHERE id_categoria ='6' ORDER BY nome ASC") or die(mysqli_error());
...
<div id="box">
  ...
  $sql = mysqli_query("SELECT * FROM tbl_carrinho WHERE comanda ='$proxima1'") or die(mysqli_error());
  $cont = mysqli_fetch_array($sql);
  $numero = $cont['comanda'];
  $proxima = $munero + 1;
  ?>
 ...
 ?>
	...
	<?php	
	$carrinho = mysqli_query("SELECT * FROM tbl_carrinho WHERE comanda='$proxima1'") or die(mysqli_error());
